...
import 'package:calculadora_capital/views/aplic/unico/detail_invest_unic_screen.dart';
                  ...
                  pw.TableRow(children: <pw.Widget>[
                    pw.Padding(
                      ...
                      child: pw.Row(
                          ...
                          children: [
                            pw.Text(
                              "Simulação Aplicação com Depósitos Unico",
                              style: pw.TextStyle(
                    ...
                    pw.Padding(
                        ...
                        child: pw.Row(
                          children: [
                            ...
                            pw.Text(
                              formatter.format(variables.liquido - variables.dado),
                            )
                          ],
                        )),
                  ]),
